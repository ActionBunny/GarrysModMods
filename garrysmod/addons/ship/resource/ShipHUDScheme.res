...
Scheme
{
	...
	BaseSettings
	{
		...
		ScoreboardModal.BgColor		"TransparentBrown"
		ScoreboardModal.FocusTransitionEffectTime	"0.0"	// time it takes for a window to fade in/out on focus/out of focus
		ScoreboardModal.TransitionEffectTime		"0.0"	// time it takes for a window to fade in/out on open/close
		
		CourtSlip.TextColor			"Black"
		
		Objectives.TextColor		"Burgundy"
		Objectives.FadedTextColor	"Grey"
	}
