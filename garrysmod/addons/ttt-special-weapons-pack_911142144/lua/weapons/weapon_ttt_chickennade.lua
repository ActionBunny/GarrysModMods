if SERVER then
	AddCSLuaFile()
	-- @ Your Stalker, you do not need to resource .vtf files, nor do you need to resource capitalisation files unless it is linux. In which case the coding standard is lowercase.
	resource.AddFile("materials/vgui/ttt/icon_gpi_chicken.vmt")
...
SWEP.Icon = "VGUI/ttt/icon_gpi_chicken.vmt"
