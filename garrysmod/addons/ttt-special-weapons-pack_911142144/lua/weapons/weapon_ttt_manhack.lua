...
-- Change this to change the manhacks health!
...
if CLIENT then
   ...
   SWEP.ViewModelFOV = 70
      ...
      SWEP.EquipMenuData = {
      type = "Weapon",
      desc = [[Throwable manhacks. What else?]]
    };
   
   SWEP.Icon = "vgui/ttt/icon_cyb_manhack.png"
...
function SWEP:PrimaryAttack()
	...
	-- Give the Anim enough time to run, but just enough, to give the impression the manhack jumped out of the players hands...
	timer.Simple(1, function()
		...
		if SERVER then
			...
			-- Less than 2? Last one. Let's remove the weapon to give some realism.
...
function SWEP:WasBought(ply)
	-- Four Extra Manhacks. Making 5 in total.
    ply:GiveAmmo(4, "Xbowbolt")
end

if SERVER then
	
	resource.AddFile("materials/vgui/ttt/icon_cyb_manhack.png")
	...
	-- Util function converted to SWEP format, checks if spot is free.
