...
CreateConVar("ttt_mineturtle_max", 2, {FCVAR_SERVER_CAN_EXECUTE, FCVAR_ARCHIVE, FCVAR_REPLICATED}, "Maximum amount of turtles everyone can carry.")
CreateConVar("ttt_mineturtle_bought", 1, {FCVAR_SERVER_CAN_EXECUTE, FCVAR_ARCHIVE, FCVAR_REPLICATED}, "Amount of turtles you receive, when you buy a Mine Turtle.")
