...
SWEP.Author			= "Hoff"
SWEP.Instructions	= "Oh yeah, drink it baby. Dropable but cannot be picked up again."
...
StaminClass = "hoff_perk_staminup"

GLOBAL_staminupTable = {}
...
self.Owner:SetNetworkedString("stamIsActive","false")
RemoveFromTable( GLOBAL_staminupTable, self.Owner )
...
if CLIENT then
   SWEP.Icon = "VGUI/ttt/icon_hoff_staminup"
