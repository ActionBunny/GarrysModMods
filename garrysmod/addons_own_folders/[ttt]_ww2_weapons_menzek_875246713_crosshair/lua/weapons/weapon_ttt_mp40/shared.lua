...
if CLIENT then
   ...
   SWEP.Icon = "vgui/entities/icon_mp40"
end
...
SWEP.Primary.Sound       = Sound( "weapons/syndod/mp40_fire.wav" )
...
SWEP.ViewModel  = "models/weapons/syndod/v_mp40.mdl"
SWEP.WorldModel = "models/weapons/syndod/w_mp40.mdl"

SWEP.IronSightsPos = Vector(-4.4, -10, 3.93)
