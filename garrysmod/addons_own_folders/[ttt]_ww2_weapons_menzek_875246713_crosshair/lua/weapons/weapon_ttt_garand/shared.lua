...
if CLIENT then
   ...
   SWEP.Icon = "vgui/entities/icon_garand"
end
...
SWEP.Primary.Sound       = Sound( "weapons/syndod/garand_fire.wav" )
local ReloadSound				= Sound ("weapons/syndod/garand_reload.wav");
...
SWEP.ViewModel  = "models/weapons/syndod/v_garand.mdl"
SWEP.WorldModel = "models/weapons/syndod/W_garand.mdl"

SWEP.IronSightsPos = Vector(-6.9455, 1, 7)
